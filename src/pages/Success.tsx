...
import { CheckCircle, XCircle, Clock12 } from 'lucide-react';
        ...
        <div className="flex justify-center mb-6">
          ...
          {isPending && (
            <div className="w-20 h-20 rounded-full bg-amber-100 flex items-center justify-center">
              <Clock12 className="w-12 h-12 text-amber-500" />
            </div>
          )}
          {isRejected && (
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">
            {isApproved
              ...
              : isPending
                ? 'Seu pedido está em análise de crédito. Em breve retornaremos com uma atualização.'
