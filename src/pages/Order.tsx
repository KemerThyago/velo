              ...
              <section className="bg-card rounded-lg p-6 shadow-elegant">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    />
                    {errors.name && <p data-testid="error-name" data-test-id="error-name" className="text-sm text-destructive">{errors.name}</p>}
                  </div>
                  <div className="space-y-2">
                    ...
                    />
                    {errors.lastname && <p data-testid="error-lastname" data-test-id="error-lastname" className="text-sm text-destructive">{errors.lastname}</p>}
                  </div>
                  <div className="space-y-2">
                    ...
                    />
                    {errors.email && <p data-testid="error-email" data-test-id="error-email" className="text-sm text-destructive">{errors.email}</p>}
                  </div>
                  <div className="space-y-2">
                    ...
                    {errors.phone && <p data-testid="error-phone" data-test-id="error-phone" className="text-sm text-destructive">{errors.phone}</p>}
                  </div>
                  <div className="space-y-2">
                    ...
                    {errors.document && <p data-testid="error-document" data-test-id="error-document" className="text-sm text-destructive">{errors.document}</p>}
                  </div>
                  <div className="space-y-2">
                    ...
                    {errors.store && <p data-testid="error-store" data-test-id="error-store" className="text-sm text-destructive">{errors.store}</p>}
                  </div>
                </div>
              </section>
              ...
              <section className="bg-card rounded-lg p-6 shadow-elegant">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    {errors.terms && <p data-testid="error-terms" data-test-id="error-terms" className="text-sm text-destructive mt-1">{errors.terms}</p>}
                  </div>
                </div>
              </section>
